...
@Slf4j
@Component
public class DateStreamListener extends AbstractAutoRetryStreamListener<String, MapRecord<String, String, Date>> {

    @Override
    public void doOnMessage(MapRecord<String, String, Date> message) {
        Map<String, Date> msgMap = message.getValue();
    ...
    public RedisStreamMetaInfoEnum getMetaInfo() {
        return RedisStreamMetaInfoEnum.STREAM_MESSAGE_DATE;
    }
